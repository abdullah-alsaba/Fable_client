      ...
      <div className="mx-auto mt-8 grid max-w-5xl grid-cols-3 gap-4 lg:grid-cols-6">
        {genres.map(({ name, icon: Icon }) => (
          <Card
            ...
            radius="none"
            shadow="none"
            className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-[#dbdad6] bg-[#f5f3ef] py-6 transition-transform duration-200 ease-out hover:scale-[1.02] cursor-pointer"
          >
